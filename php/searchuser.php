...
<table>
	<?php
		$data2 = mysql_query("select * from article where  username like '%".$key."%' order by dateline desc");
	...
	?>
			...
			<tr>
				<td width="50%">这是内容：<a href="./info.php?id=<?php echo $row['id'];?>"><?php echo $row['title'];?></a></td>
				<td>author<a href="./searchuser.php?key=<?php echo $row['username'];?>"><?php echo $row['username'];?></a></td>
				<td><font><?php echo $row['body'];?></font></td>
			</tr>
	<?php
	}
